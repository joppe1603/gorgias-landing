  ...
  for (const order of orders) {
    ...
    try {
      await resend.emails.send({
        ...
        to: order.email,
        subject: 'Je winkelwagen wacht nog op je — LUMÉ',
        html: `
          <!DOCTYPE html>
          <html lang="nl">
                ...
                <table width="520" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;overflow:hidden;border:1px solid #E8E4DF;">
                  <tr>
                    <td style="background:#0F0E0C;padding:28px 36px;text-align:center;">
                      <p style="margin:0;font-size:24px;font-weight:600;letter-spacing:0.1em;color:#FAF8F5;font-family:Georgia,serif;">LUMÉ</p>
                    </td>
                  </tr>
                  <tr>
                    <td style="padding:36px;">
                      ...
                      <a href="https://lume-skincare.nl/checkout" style="display:block;background:#C9A96E;color:#1A1A1A;text-decoration:none;text-align:center;padding:14px 28px;border-radius:14px;font-weight:600;font-size:14px;letter-spacing:0.02em;">
                  ...
                  <tr>
                    <td style="background:#FAF8F5;padding:18px 36px;text-align:center;border-top:1px solid #E8E4DF;">
                      <p style="margin:0;font-size:10px;color:#9A9590;">LUMÉ Skincare · lume-skincare.nl</p>
                    </td>
                  </tr>
                </table>
              </td></tr>
