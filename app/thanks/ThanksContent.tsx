  ...
  return (
    <main className="min-h-screen bg-[#0F0E0C] flex items-center justify-center relative overflow-hidden px-6">
      ...
      <div className="relative z-10 max-w-lg w-full text-center">
        ...
        <motion.h1
          {...stagger(1)}
          className="text-[clamp(2.4rem,6vw,3.8rem)] font-semibold text-white leading-[1.08] tracking-[-0.022em] mb-8"
        ...
        <motion.div {...stagger(3)} className="space-y-4 mb-12">
          <p className="text-[16px] text-stone-300 font-light leading-relaxed">
            De eerste batch wordt bewust klein gehouden.
          </p>
          <p className="text-[15px] text-stone-500 font-light leading-relaxed">
            We delen updates tijdens sample testing en productontwikkeling.
          </p>
          <p className="text-[14px] text-stone-600 font-light leading-relaxed italic">
            Geen spam. Geen hype. Alleen updates wanneer het ertoe doet.
          </p>
        </motion.div>
